...
const products = [
  {
    ...
    description: "Projet d'inhalateur à base d'extraits végétaux (spiruline, anthocyanes, phycocyanine), sans nicotine. Phase pré-commerciale.",
    icon: 'AV',
    gradient: 'from-[#8B2C5A] to-[#1E88E5]',
    href: '/aquevent',
    features: ['Extraits végétaux', 'Sans nicotine', 'Liste d\'attente', 'En développement'],
    badge: 'PRÉ-SÉRIE',
  ...
  },
  {
    id: 'phytotech',
    name: 'PhytoTech Home',
    description: "Kits bio-énergie utilisant plantes, algues et eau pour la production d'électricité, la purification d'air et le recyclage d'eau.",
    icon: 'PT',
